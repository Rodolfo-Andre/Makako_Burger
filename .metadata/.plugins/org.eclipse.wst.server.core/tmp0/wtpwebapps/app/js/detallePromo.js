	...
	$d.addEventListener("click", (e) => {
				...
				success: async (json) => {
					...
					if (promoInfo) {
						...
						let contenModal = {
							...
							footer: `<input id="b-promo" form="form-add" type="submit" class="flex-grow-1 btn btn-warning text-white" value="ACTUALIZAR"/>
		...
		if ($btnAgregarProducto == e.target) {
			let contenModal = {
				...
				footer: `<input id="b-prod" form="form-add" type="submit" class="flex-grow-1 btn btn-primary" value="AÑADIR"/>
						<button data-bs-dismiss="modal" aria-label="Close" class="flex-grow-1 btn btn-primary">CANCELAR</button>`
			}
		...
		if ($listBtnModificarProd.includes(e.target)) {
			...
			let contenModal = {
				...
				footer: `<input id="u-prod" form="form-update" type="submit" class="flex-grow-1 text-white btn btn-warning" value="MODIFICAR"/>
						<button data-bs-dismiss="modal" aria-label="Close" class="flex-grow-1 btn btn-primary">CANCELAR</button>`
			}
