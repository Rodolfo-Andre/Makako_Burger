			...
			let props = {
				...
				success: async (json) => {
					...
					let contentModal = {
						...
						footer: `<input id= 'b-emp' form="form-add"  type="submit" class="flex-grow-1 btn btn-primary" value="AÑADIR"/>
						...
						success: async (json) => {
							...
							if (EmpInfo) {
								let contentModal = {
									...
									footer: `<input form="form-update" type="submit" class="flex-grow-1 text-white btn btn-warning" value="MODIFICAR"/>
											<button data-bs-dismiss="modal" aria-label="Close" class="flex-grow-1 btn btn-primary">CANCELAR</button>	`
								}
